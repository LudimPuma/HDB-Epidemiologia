...
<div class="container">
    <div class="row">
        <div class="col-md-12 offset-md">
            <div class="card">
                <br>
                <h2 class="text-center">Patologia</h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('crud-edit-patologia')
                                            <button class="btn-editar" data-id="{{ $patologia->cod_patologia }}" data-nombre="{{ $patologia->nombre }}" data-estado="{{ $patologia->estado ? true : false }}" data-motivos="{{ $patologia->motivos_baja }}" style="background: none; border: none;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-modificar" method="POST" action="{{ route('patologia.update', ['patologia' => ':id']) }}">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="modalInsertar" tabindex="-1" aria-labelledby="modalInsertarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-insertar" method="POST" action="{{ route('patologia.store') }}">
                    @csrf
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" class="form-control" required>
