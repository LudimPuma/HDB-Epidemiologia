  ...
  <body>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="#"> Enfermedades de Notificacion Inmediata </a>
              </li>
              <li>
                <a href="#"> IAAS </a>
              </li>
    ...
    <main class="main-wrapper">
      ...
      <div class="container-fluid">
          <div class="row">
            <div class="col">
            <form action="{{ route('agente.update', $agente->cod_agente_causal) }}" method="POST">
                @csrf
                @method('PUT')
                <label for="nombre">Nombre</label>
                <input type="text" name="nombre" value="{{ $agente->nombre }}">
