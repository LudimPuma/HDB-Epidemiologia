                    ...
                    <div class="card-body">
                        <table id="dataTable"  class="table text-center mt-3 table-hover table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <td>
                                    @can('crud-edit-hongo')
                                        <button class="btn-editar" data-id="{{ $hongo->id }}" data-nombre="{{ $hongo->nombre }}" data-estado="{{ $hongo->estado ? true : false }}" data-motivos="{{ $hongo->motivos_baja }}" style="background: none; border: none;">
