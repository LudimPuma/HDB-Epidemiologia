@extends('layout')
@section('title', 'Tablas | Servicios')
@section('guide','Tablas / Servicios')
@section('content')
<div class="row">
    <div class="col-12">
                        ...
                        <table id="dataTable" class="table mt-3 table-hover">
                            ...
                            <tbody class="text-muted">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('crud-edit-servicio')
                                            <button class="btn-editar text-muted" style="background: none; border: none; text-decoration: none;" data-id="{{ $servicio->cod_servicio }}" data-nombre="{{ $servicio->nombre }}" data-estado="{{ $servicio->estado ? true : false }}" data-motivos="{{ $servicio->motivos_baja }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-modificar" method="POST" action="{{ route('servicio.update', ['servicio' => ':id']) }}">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="modalInsertar" tabindex="-1" aria-labelledby="modalInsertarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalInsertarLabel">Insertar Servicio</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="form-insertar" method="POST" action="{{ route('servicio.store') }}">
                    @csrf
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" class="form-control" required>
