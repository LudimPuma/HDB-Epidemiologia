...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
              <button class="btn btn-primary btn-insertar">Crear Medicamento</button>
            </div>
        </div>
        <div class="row">
          <div class="col">
            <table class="table table-hover align-middle">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center">{{ $medicamento->cod_medicamento }}</td>
                  <td>{{ $medicamento->nombre }}</td>
                  <td class="text-center">
                    <button class="btn btn-info btn-editar" data-id="{{ $medicamento->cod_medicamento }} " data-nombre="{{ $medicamento->nombre }}">Editar</button>
      ...
      <script>
        ...
        $.each(data, function(index, medicamento) {
            var row = $('<tr>');
            row.append('<td class="text-center">' + medicamento.cod_medicamento + '</td>');
            row.append('<td>' + medicamento.nombre + '</td>');
