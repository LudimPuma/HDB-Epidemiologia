@extends('layout')
@section('title', 'Tablas | Tipo de Muestra para Cultivo')
@section('guide','Tablas / Tipo de Muestra para Cultivo')
@section('content')
<div class="row">
    <div class="col-12">
                    ...
                    <div class="mb-20">
                        @can('crud-create-tipoMuestra')
                            <button class="btn btn-success btn-insertar" style="padding: 1%;">
                                ...
                                <strong>Agregar Tipo de Muestra</strong>
                            </button>
                        @endcan
                    </div>
                </div>
                        ...
                        <table id="dataTable" class="table mt-3 table-hover">
                            ...
                            <tbody class="text-muted">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('crud-edit-tipoMuestra')
                                            <button class="btn-editar text-muted" style="background: none; border: none; text-decoration: none;" data-id="{{ $tipoMuestra->cod_tipo_muestra }}" data-nombre="{{ $tipoMuestra->nombre }}" data-estado="{{ $tipoMuestra->estado ? true : false }}" data-motivos="{{ $tipoMuestra->motivos_baja }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalModificarLabel">Modificar Tipo de Muestra</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="form-modificar" method="POST" action="{{ route('tipoMuestra.update', ['tipoMuestra' => ':id']) }}">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="modalInsertar" tabindex="-1" aria-labelledby="modalInsertarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalInsertarLabel">Insertar Tipo de Muestra</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="form-insertar" method="POST" action="{{ route('tipoMuestra.store') }}">
                    @csrf
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" class="form-control" required>
