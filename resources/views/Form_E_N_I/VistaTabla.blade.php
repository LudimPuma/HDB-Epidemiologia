@extends('layout')
@section('title', 'Tabla | Enf. de Notificación Inmediata')
@section('guide', 'Tabla / Enf. de Notificación Inmediata')
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @can('button-form-pdf-eni')
                                                <a href="{{ route('vista-previa-pdf', $patient['id_f_notificacion_inmediata']) }}" class="btn" target="_blanck">
                                            ...
                                            @endcan
                                            @can('edit-form-eni')
                                                <button class="btn-editar text-muted" style="background: none; border: none; text-decoration: none;" data-id="{{ $patient['id_f_notificacion_inmediata']}}" data-h="{{$patient['h_clinico']}}" data-fecha_llenado="{{$patient['fecha'] }}" data-nombre="{{ $patient['nombre'] }} {{ $patient['ap_paterno'] }} {{ $patient['ap_materno'] }}" data-estado="{{ $patient['estado'] }}" data-motivos="{{ $patient['motivos_baja'] }}">
